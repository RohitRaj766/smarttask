export function getForgotPasswordTemplate(name: string, otp: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Reset Password - SmartTask</title>
  <style>
    ...
    .otp-box { background: #fef3c7; border: 2px dashed #f59e0b; border-radius: 8px; font-size: 32px; font-weight: 800; color: #b45309; text-align: center; padding: 16px; margin: 24px 0; letter-spacing: 8px; }
...
<body>
  <div class="card">
    ...
    <p>Hello ${name},</p>
    <p>We received a request to reset the password for your SmartTask account. Use the following 6-digit OTP code to verify your request:</p>
    
    <div class="otp-box">${otp}</div>
    
    <p style="font-size: 13px; color: #6b7280;">This code is valid for <strong>10 minutes</strong>. If you did not initiate a password reset, your account is secure and you can safely ignore this email.</p>
